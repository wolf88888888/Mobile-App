...
import { getListingsByFilter,getTopHomes } from '../../../utils/requester';
...
class PropertyList extends React.Component{
    ...
    constructor(props){
        ...
        this.state.urlForHomes = 'countryId='+params.countryId+'&startDate='+params.startDate+'&endDate='+params.endDate+'&guests='+this.state.guests+'&priceMin=0&priceMax=5000';
    }
    ...
    loadHomes = () => {
        ...
        getListingsByFilter(this.state.urlForHomes)
        .then(res => res.response.json())
        .then((json) => {
            this.setState({
                homes: json.filteredListings.content,
                isLoading: false,
              });
        })
        .catch(err => {
